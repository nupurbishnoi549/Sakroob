...
const Hero = () => {
    return (
        <div className="relative px-4 pb-[43px]">
            <div className="relative">
                <Swiper
                    ...
                    autoplay={{ delay: 4000 }}
                    loop={true}
                    className="w-full xl:h-[650px] lg:h-[600px] h-[450px] rounded-2xl overflow-hidden"
                >
                            ...
                            >
                                <div className="max-w-2xl text-dark-blue p-6 max-md:pb-0 max-md:pt-26 rounded-xl">
                                    ...
                                    <div className="flex max-md:flex-col justify-center gap-4">
                                        <Button btnText="Browse Products" btnClass="bg-dark-blue px-5 rounded-full text-white" />
                                        <Button btnText="Starter Kits" btnClass="px-5 rounded-full hover:bg-[#112D49] hover:text-white" />
