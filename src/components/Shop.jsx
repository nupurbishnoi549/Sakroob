...
const Shop = () => {
    return (
        <div id='diy-services' className="py-14 bg-white text-center px-4 xl:py-[132px] lg:py-24 md:py-20  max-w-[1920px] mx-auto">
            ...
            <div className="flex flex-wrap justify-center gap-6 max-w-[1400px] mx-auto">
                <div className="rounded-xl pt-6 flex flex-col md:flex-row justify-between items-center gap-6 bg-light-blue w-full md:w-[680px] md:pl-16">
                    ...
                    <img src={sensorImg} alt="Sensors & Modules" className="w-[300px] md:w-[372px] h-[200px] md:h-[261px] pointer-events-none" />
                </div>
                <div className="rounded-xl pt-8 flex flex-col justify-between items-center w-full md:w-[328px] bg-blue px-4">
                    ...
                    <img src={pcPartsImg} alt="Custom PC Parts" className="w-[150px] md:w-[174px] h-[180px] md:h-[213px] mt-auto mx-auto pointer-events-none" />
                </div>
                <div className="rounded-xl pt-[46px] pb-4 flex flex-col text-center items-center w-full md:w-[328px] px-4 bg-silver">
                    ...
                    <img src={diyImg} alt="DIY Tools" className="w-[160px] md:w-[184px] h-[180px] md:h-[208px] object-contain pointer-events-none" />
                </div>
                <div className="rounded-xl pt-6 flex flex-col justify-between md:text-right md:items-end w-full md:w-[328px] bg-blue pr-4">
                    ...
                    <img src={cablesImg} alt="Cables & Connectors" className="w-[240px] md:w-[306px] h-[200px] md:h-[261px] mt-auto pointer-events-none" />
                </div>
                <div className="rounded-xl pt-6 pb-4 flex flex-col text-center items-center w-full md:w-[328px] px-4 bg-silver">
                    ...
                    <img src={gamingImg} alt="Gaming Peripherals" className="w-[220px] md:w-[266px] h-[160px] md:h-[184px] object-contain pointer-events-none" />
                </div>
                <div className="rounded-xl pt-6 flex flex-col justify-between text-center items-center w-full md:w-[680px] bg-light-blue">
                    ...
                    <img src={raspberryImg} alt="Raspberry Pi Kits" className="w-full md:w-[680px] h-[240px] md:h-[240px] mt-auto pointer-events-none" />
                </div>
